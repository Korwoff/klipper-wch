...
typedef enum IRQn
{
    ...
    USART2_IRQn = 39,        /* USART2 global Interrupt (CH32V005/V006)              */
    OPCM_IRQn = 40,          /* OPCM global Interrupt (CH32V005/V006)               */
...
#define USART2_BASE                             (APB1PERIPH_BASE + 0x4400) /* CH32V005/V006 */

#define AFIO_BASE                               (APB2PERIPH_BASE + 0x0000)
#define EXTI_BASE                               (APB2PERIPH_BASE + 0x0400)
#define GPIOA_BASE                              (APB2PERIPH_BASE + 0x0800)
#define GPIOB_BASE                              (APB2PERIPH_BASE + 0x0C00) /* CH32V005/V006 */
